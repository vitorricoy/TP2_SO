...
int main(int argc, char** argv) {
    ...
    for(unsigned I=0; I<2; I++) {
        ...
        printsTabelas[I] = (char*) malloc(101*((tamanhoMemoria/tamanhoPagina)+1)*sizeof(char) + sizeof(char));
        ...
        for(unsigned J=0; J<101*((tamanhoMemoria/tamanhoPagina)+1)+1; J++) {
            printsTabelas[I][J] = '\0';
        }
    ...
    printf("Paginas lidas do disco (page faults): %u\n", contadorPageFaults);
